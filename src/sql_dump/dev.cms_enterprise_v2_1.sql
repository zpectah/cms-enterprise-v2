...
('language_installed',	'en-US,cs-CZ',	'array',	'default',	'language'),
('language_active',	'en-US,cs-CZ',	'array',	'default',	'language'),
...
INSERT INTO `comments` (`id`, `type`, `email`, `title`, `content`, `assigned`, `assigned_id`, `parent`, `status`, `created`) VALUES
...
INSERT INTO `menu_items` (`id`, `type`, `name`, `page_id`, `path_url`, `menu_id`, `parent`, `item_order`, `active`, `deleted`) VALUES
