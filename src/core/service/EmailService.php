...
class EmailService {
    ...
    private function create_message ($to, $subject, $content, $headers, $context, $from): bool {
        ...
        $message_content .= "<div style='width:100%;padding:3rem 2rem;text-align:center;'><h1 style='margin:0;padding:0 0 2rem 0;font-size:1.75rem;font-weight:normal;'>" . "CMS NAME" . ": " . $subject . "</h1><div>";
        $message_content .= $content;
