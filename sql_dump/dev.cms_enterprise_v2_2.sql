...
DROP TABLE IF EXISTS `categories__sk_sk`;
CREATE TABLE `categories__sk_sk` (
  `id` int(11) NOT NULL,
  `title` text NOT NULL,
  `description` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `categories__sk_sk` (`id`, `title`, `description`) VALUES
(1,	'První kategorie',	''),
(2,	'Druhá kategorie',	'gfdh dfhdfghdfgh');
...
('project_name',	'YOUR PROJECT NAME',	'string',	'default',	'project'),
('project_description',	'YOUR PROJECT DESCRIPTION',	'string',	'default',	'project'),
('language_installed',	'en-US,cs-CZ,sk-SK',	'array',	'default',	'language'),
('language_active',	'en-US,cs-CZ,sk-SK',	'array',	'default',	'language'),
('language_default',	'cs-CZ',	'string',	'default',	'language'),
('web_meta_title',	'WEB TITLE',	'string',	'default',	'web'),
('web_meta_description',	'YOUR WEB META DESCRIPTION',	'string',	'default',	'web'),
('web_meta_robots',	'all',	'string',	'default',	'web'),
('web_meta_keywords',	'key1,key2,key3',	'array',	'default',	'web'),
('web_mode_maintenance',	'true',	'boolean',	'default',	'web'),
('web_mode_debug',	'true',	'boolean',	'default',	'web'),
('company_name',	'YOUR COMPANY NAME',	'string',	'default',	'company'),
('company_description',	'YOUR COMPANY DESCRIPTION',	'string',	'default',	'company'),
('company_id',	'ID123456789',	'string',	'default',	'company'),
('company_address',	'YOUR COMPANY ADDRESS 333/10',	'string',	'default',	'company'),
('company_city',	'YOUR COMPANY CITY',	'string',	'default',	'company'),
('company_country',	'YOUR COMPANY COUNTRY',	'string',	'default',	'company'),
('company_zip',	'CZ465465456',	'string',	'default',	'company'),
('company_location',	'14.449727369517,50.045754221915',	'array',	'default',	'company'),
('company_email',	'example2@example.example,example3@example.example',	'array',	'default',	'company'),
('company_phone',	'420123456789,420987654321',	'array',	'default',	'company'),
('company_bank',	'0000/0000',	'string',	'default',	'company'),
('form_email_sender',	'noreply@your-project.example',	'string',	'default',	'web'),
('form_email_recipients',	'sychrat@gmail.com,noreply@example.example',	'array',	'default',	'web'),
('comments_global_active',	'true',	'boolean',	'default',	'web'),
('comments_anonymous_active',	'true',	'boolean',	'default',	'web'),
('members_register_active',	'true',	'boolean',	'default',	'members'),
('members_login_active',	'true',	'boolean',	'default',	'members'),
('members_lostPassword_active',	'true',	'boolean',	'default',	'members'),
('members_profile_active',	'true',	'boolean',	'default',	'members'),
('social_url_facebook',	'https://www.facebook.com',	'string',	'url',	'web'),
('social_url_twitter',	'https://www.twitter.com',	'string',	'url',	'web'),
('social_url_linkedin',	'',	'string',	'url',	'web'),
('social_url_youtube',	'',	'string',	'url',	'web'),
('social_url_twitch',	'',	'string',	'url',	'web'),
('social_url_github',	'',	'string',	'url',	'web');
...
(1,	'external',	'first-external-link',	'',	'http://google.com',	'',	1,	'',	10,	1,	0),
(2,	'external',	'submerged-link',	'2',	'http://neco.nekam',	'',	1,	'1',	2,	1,	0),
(3,	'page',	'some-page-link',	'1',	'',	'',	1,	'',	6,	1,	0);
...
DROP TABLE IF EXISTS `menu_items__sk_sk`;
CREATE TABLE `menu_items__sk_sk` (
  `id` int(11) NOT NULL,
  `label` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `menu_items__sk_sk` (`id`, `label`) VALUES
(1,	'Google'),
(2,	'Neco nekam'),
(3,	'Nějaká stránka');
...
DROP TABLE IF EXISTS `menu__sk_sk`;
CREATE TABLE `menu__sk_sk` (
  `id` int(11) NOT NULL,
  `label` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `menu__sk_sk` (`id`, `label`) VALUES
(1,	'Hlavní menu');
...
DROP TABLE IF EXISTS `pages__sk_sk`;
CREATE TABLE `pages__sk_sk` (
  `id` int(11) NOT NULL,
  `title` text NOT NULL,
  `description` text NOT NULL,
  `content` longtext NOT NULL
...
INSERT INTO `pages__sk_sk` (`id`, `title`, `description`, `content`) VALUES
(1,	'Výchozí stránka',	'',	'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in tincidunt neque. Nulla sollicitudin consectetur consequat. Aliquam erat volutpat. Nulla aliquet dignissim odio, nec fermentum erat fringilla porta. In hac habitasse platea dictumst. Vestibulum est lacus, fringilla sit amet nulla ut, egestas sagittis augue. Praesent eget lobortis arcu. Sed dapibus interdum ex, sit amet mollis tortor laoreet sed. Vestibulum non consectetur nunc. Aenean ac pulvinar ex. In consectetur et diam non ultricies. Etiam tempor arcu nec mi interdum, eget tempor leo pulvinar. Etiam ac pharetra sem. Vivamus eget feugiat lacus. Duis non augue nec urna consequat fermentum eget non risus. Quisque tempor velit at mollis volutpat.'),
(2,	'Stránka s kategorií',	'',	'');
...
(1,	'article',	'first-post',	'2',	'2',	'',	'',	'0,0',	'',	'',	'',	'',	'',	'',	'http://www.some-link.com',	'pluto.jpeg',	'7ajjMf5.jpeg',	'2022-03-08T16:49:12.000+01:00',	1,	0,	0,	1,	0),
(2,	'blog',	'blog-post',	'1',	'1',	'',	'',	'0,0',	'',	'',	'',	'',	'',	'',	'',	'9pFRwJB.jpeg',	'9pFRwJB.jpeg',	'2022-03-11T16:48:55.000+01:00',	1,	0,	0,	1,	0),
(3,	'event',	'event-post',	'1',	'2',	'2022-03-12T16:26:22.000+01:00',	'2022-03-20T16:26:27.000+01:00',	'14.501346284326,50.083092212966',	'',	'',	'',	'',	'4,5,6,7,8',	'',	'',	'team-skeet-01.jpg',	'IMG_0195.jpg',	'2022-03-20T16:27:07.000+01:00',	1,	0,	0,	1,	0),
...
DROP TABLE IF EXISTS `posts__sk_sk`;
CREATE TABLE `posts__sk_sk` (
  `id` int(11) NOT NULL,
  `title` text NOT NULL,
  `description` text NOT NULL,
  `content` longtext NOT NULL
...
INSERT INTO `posts__sk_sk` (`id`, `title`, `description`, `content`) VALUES
(1,	'První post',	'd dfg hdfgh dgf',	'df hdfg hdfghdfgh'),
(2,	'dfghdfg',	'dfghdfgh čivava',	'dfghdfghdf'),
(3,	'Událost',	'dfg dfgh dfgh dfghdfgh',	''),
(4,	'Stevie Wonder',	'sdfgsdfgsdfg',	'');
...
DROP TABLE IF EXISTS `translations__sk_sk`;
CREATE TABLE `translations__sk_sk` (
  `id` int(11) NOT NULL,
  `value` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `translations__sk_sk` (`id`, `value`) VALUES
(1,	'Otevřít'),
(2,	'Zavřít');
...
(12,	'image',	'green-hell-map-3',	'green-hell-map-3.jpg',	'jpg',	'image/jpeg',	'1031936',	'2022-03-20 09:18:49',	1,	0),
(13,	'image',	'green-hell-map-2',	'green-hell-map-2.jpg',	'jpg',	'image/jpeg',	'1161411',	'2022-03-20 09:18:50',	1,	0),
(14,	'image',	'xV23r3z',	'xV23r3z.jpeg',	'jpeg',	'image/jpeg',	'145029',	'2022-03-20 09:26:19',	1,	0),
(15,	'image',	'ujRTM8f',	'ujRTM8f.jpeg',	'jpeg',	'image/jpeg',	'155681',	'2022-03-20 09:26:19',	1,	0),
(16,	'image',	'T0C75NL',	'T0C75NL.jpeg',	'jpeg',	'image/jpeg',	'161349',	'2022-03-20 09:28:47',	1,	0),
(17,	'image',	'ujRTM8f2',	'ujRTM8f2.jpeg',	'jpeg',	'image/jpeg',	'155681',	'2022-03-20 09:28:48',	1,	0);
...
DROP TABLE IF EXISTS `uploads__sk_sk`;
CREATE TABLE `uploads__sk_sk` (
  `id` int(11) NOT NULL,
  `label` text NOT NULL,
  `description` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `uploads__sk_sk` (`id`, `label`, `description`) VALUES
(1,	'',	''),
(2,	'',	''),
(3,	'aaaaa',	''),
(4,	'',	''),
