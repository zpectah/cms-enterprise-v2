...
('language_installed',	'cs-CZ,en,sk-SK',	'array',	'app',	'language'),
('language_active',	'cs-CZ,sk-SK,en',	'array',	'app',	'language'),
...
('company_phone',	'420123456789,420987654321,420444555777',	'array',	'app',	'company'),
...
('likes_global_enabled',  'true', 'boolean',  'app',  'web'),
('social_url_facebook',	'https://www.facebook.com',	'string',	'app',	'web'),
('social_url_twitter',	'https://www.twitter.com',	'string',	'app',	'web'),
('social_url_linkedin',	'https://www.linkedin.com',	'string',	'app',	'web'),
('social_url_youtube',	'https://www.youtube.com',	'string',	'app',	'web'),
('social_url_twitch',	'https://www.twitch.com',	'string',	'app',	'web'),
('social_url_github',	'https://www.github.com',	'string',	'app',	'web');
